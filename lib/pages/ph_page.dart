      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Text(
              "Statistik pH Tanah 7 hari terakhir",
              style: brownText.copyWith(fontSize: 16, fontWeight: semibold),
            ),
          ),
          Padding(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Data",
                  style: brownText.copyWith(fontSize: 20, fontWeight: bold),
                ),
              ],
            ),
          ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      "5.0",
                      style: brownText.copyWith(fontWeight: bold),
                    ),
                    Text("9.6", style: brownText.copyWith(fontWeight: bold)),
                    Text("8.0", style: brownText.copyWith(fontWeight: bold)),
                    Text("6.1", style: brownText.copyWith(fontWeight: bold)),
                    Text("5.2", style: brownText.copyWith(fontWeight: bold)),
                    Text("2.1", style: brownText.copyWith(fontWeight: bold)),
                    Text("5.0", style: brownText.copyWith(fontWeight: bold)),
                  ],
                )
              ],
            ),
